...
function setAllInactive(){
  ...
  ['navHome','navMQ','navMV','navQQ','navMC','navFL','navLQ','navWQ','navQR','navAdminDash','navAdminLogos','navAdminWords'].forEach(id=>{const el=document.getElementById(id);if(el)el.classList.remove('active');});
