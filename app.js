    ...
    if(q.audioData){
      ...
      if(ytMatch && round.type==='movie'){
        ...
        const _initMvPlayer=function(){
          window._ytPlayer=null; window._mvMuted=false;
...
function mvPlayToggle(){
  const p=window._ytPlayer; if(!p||!p.playVideo)return;
  try{
